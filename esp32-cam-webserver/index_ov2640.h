...
<html>
    ...
    <section class="main">
      ...
      <div id="content">
        <div class="hidden" id="sidebar">
          <input type="checkbox" id="nav-toggle-cb" checked="checked">
            <nav id="menu">
              ...
              <div class="input-group hidden" id="verticalServoPos" title="Vertical servo controller">
                <label for="verticalServoSlider">Vertical</label>
                <div class="range-min">0</div>
                <input type="range" id="verticalServoSlider" min="0" max="90" value="0" class="default-action">
                <div class="range-max">90</div>
              </div>
              <div class="input-group hidden" id="horizontalServoPos" title="Horizontal servo controller">
                <label for="horizontalServoSlider">Horizontal</label>
                <div class="range-min">0</div>
                <input type="range" id="horizontalServoSlider" min="0" max="180" value="0" class="default-action">
                <div class="range-max">180</div>
              </div>
              <div class="input-group hidden" id="steeringServoPos" title="Steering servo controller">
                <label for="steeringServoSlider">Steering</label>
                <div class="range-min">0</div>
                <input type="range" id="steeringServoSlider" min="0" max="360" value="0" class="default-action">
                <div class="range-max">360</div>
              </div>
              <div class="input-group hidden" id="motorAction" title="Motor controller">
                <label for="motorController">Motor</label>
                <div class="range-min">-1</div>
                <input type="range" id="motorController" min="-1" max="1" value="0" class="default-action">
        ...
        <figure>
          ...
          <div class="container">
            <div class="arrow-keys" id="wasd-keys">
              <div></div>
            ...
            <div class="arrow-keys" id="arrow-keys">
              <div></div>
  ...
  document.addEventListener('DOMContentLoaded', function (event) {
    ...
    const vertical = document.getElementById('verticalServoPos')
    const horizontal = document.getElementById('horizontalServoPos')
    const steering = document.getElementById('steeringServoPos')
    const motor = document.getElementById('motorAction')
    ...
    const updateValue = (el, value, updateRemote) => {
      ...
      if (updateRemote && initialValue !== value) {
        ...
        } else if(el.id === "verticalServoSlider"){
          (value == -1) ? hide(vertical) : show(vertical)
        } else if(el.id === "horizontalServoSlider"){
          (value == -1) ? hide(horizontal) : show(horizontal)
        } else if(el.id === "steeringServoSlider"){
          (value == -1) ? hide(steering) : show(steering)
        } else if(el.id === "motorController"){
          (value == -1) ? hide(motor) : show(motor)
    ...
    keys.forEach(key => {
      ...
      key.addEventListener('mouseup', function() {
        ...
        if (key.id == 'a' || key.id == 'd'){       
          steeringServoSlider.value = 50;
          updateRangeConfig(steeringServoSlider);
        }
        if (keyId == 'w' || keyId == 's'){       
          motorController.value = 0;
          updateRangeConfig(motorController);
        }
      });
    ...
    document.addEventListener('keydown', (event) => {
      ...
      if (keyElement) {
        ...
        controlServo(event.key);
    });

    function controlServo(arrow){
      switch (arrow) {
        case 'ArrowUp':
          if (verticalServoSlider.value > 0) {
            verticalServoSlider.value = parseInt(verticalServoSlider.value) - 1;
            updateRangeConfig(verticalServoSlider);
          }
          break;
        case 'ArrowDown':
          if (verticalServoSlider.value < 90) {
            verticalServoSlider.value = parseInt(verticalServoSlider.value) + 1;
            updateRangeConfig(verticalServoSlider);
          }
          break;
        case 'ArrowLeft':
          if (horizontalServoSlider.value < 180) {
            horizontalServoSlider.value = parseInt(horizontalServoSlider.value) + 1;
            updateRangeConfig(horizontalServoSlider);
          }
          break;
        case 'ArrowRight':
          if (horizontalServoSlider.value > 0) {
            horizontalServoSlider.value = parseInt(horizontalServoSlider.value) - 1;
            updateRangeConfig(horizontalServoSlider);
          }
          break;
        case 'a':
          steeringServoSlider.value = 100;
          updateRangeConfig(steeringServoSlider);
          break;
        case 'd':
          steeringServoSlider.value = 0;
          updateRangeConfig(steeringServoSlider);
          break;
        case 'w':
          motorController.value = 1;
          updateRangeConfig(motorController);
          break;
        case 's':
          motorController.value = -1;
