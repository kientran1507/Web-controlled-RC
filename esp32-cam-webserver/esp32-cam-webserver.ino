...
#if defined(VERTICAL_SERVO_PIN)
  int vPos = 45; //default to 45 degree
  Servo verticalServo;
#endif

#if defined(HORIZONTAL_SERVO_PIN)
  int hPos = 90; //default to 90 degree
  Servo horizontalServo;
#endif

#if defined(STEERING_SERVO_PIN)
  int sPos = 50; //default to 50 degree
  Servo steeringServo;
#endif

#if defined(MOTOR_PIN_1)
  int action = 0; //default to stop
#endif
